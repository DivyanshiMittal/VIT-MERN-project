...
import signupImage from './assets/signupimage.png'; // Import the image
    ...
    return (
        <div className="sign-up-page">
            <div className="dashboard">
                <button onClick={() => window.location.href = 'user.html'}>User</button>
                <button onClick={() => window.location.href = 'agent.html'}>Agent</button>
